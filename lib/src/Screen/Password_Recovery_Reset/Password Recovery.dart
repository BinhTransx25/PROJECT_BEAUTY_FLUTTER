            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: ClipOval(
                    child: Image.asset(
                        'lib/src/assets/PasswordRecovery/avatar.png',
                        width: 90,
                        height: 90),
                  ),
                ),
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: isSMSChecked
                                      ? Image.asset(
                                          'lib/src/assets/PasswordRecovery/check.png')
                                      : null,
                                ),
                              ),
                            ],
